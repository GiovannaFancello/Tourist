...
%In order to help policy making in define new public policies, this work  aims to define the tourists values in space in respect to the correspondent tourist socio-professional class and behaviours. This allows to define territorial development policies focused to specific tourist population and to improve the urban opportunities of the territory.
